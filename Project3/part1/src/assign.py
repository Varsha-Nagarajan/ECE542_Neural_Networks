...
def assign_weight_count_all_0_case_2(cell, in_dim, out_dim):
    """ Parameters for counting all the '0' in the squence
...
def assign_weight_count_all_0_case_3(cell, in_dim, out_dim):
...
def assign_weight_count_all_0_case_4(cell, in_dim, out_dim):
